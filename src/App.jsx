      ...
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          ...
          if (index > 0 && !guestRef.current) {
            document.getElementById('page-0')?.scrollIntoView({ behavior: 'smooth', block: 'start' })
