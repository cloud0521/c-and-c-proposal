...
export default function App() {
  ...
  return <main className={`invitation-app ${keyboardOpen ? 'keyboard-open' : ''}`} ref={containerRef}>
    ...
    <div className={`glitters-container ${page === 2 ? 'page-2-active' : ''}`}>
      {sparkles.map(s => (
        <div
          key={s.id}
          className="glitter"
