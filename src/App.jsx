...
export default function App() {
  ...
  // Scroll the container when keyboard opens
  useEffect(() => {
      ...
      <div className="page-inner">
        ...
        <div className="lookup">
          <input 
            ...
            onBlur={() => {
              setTimeout(() => setKeyboardOpen(false), 350);
            }}
