...
.zoomed-splash-logo{object-fit:contain;transform-origin:center center;animation:logoGrowToCenterSequence 0.4s cubic-bezier(0.16,1,.3,1) forwards;pointer-events:none}
.logo-zoom-overlay.closing .zoomed-splash-logo{animation:logoShrinkBackSequence 0.4s cubic-bezier(0.16,1,.3,1) forwards}

@keyframes logoGrowToCenterSequence{0%{transform:translate(0px,0px) scale(1)}100%{transform:translate(var(--delta-x,0px),var(--delta-y,0px)) scale(2.5)}}
@keyframes logoShrinkBackSequence{0%{transform:translate(var(--delta-x,0px),var(--delta-y,0px)) scale(2.5)}100%{transform:translate(0px,0px) scale(1)}}
@keyframes fadeInOverlay{from{opacity:0}to{opacity:1}}`}</style>
