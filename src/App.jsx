...
export default function App() {
  ...
  const handleAnimationEnd = (e) => {
    if (e.animationName === 'shakeAndGrow') {
      e.currentTarget.classList.remove('shake-anim');
    }
  }
